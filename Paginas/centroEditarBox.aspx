<%@ Page Title="" Language="C#" MasterPageFile="~/AdmCentro.Master" AutoEventWireup="true" CodeBehind="centroEditarBox.aspx.cs" Inherits="Paginas.centroEditarBox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center">
    <tr>
        <td align="center"><strong>Modificar Box de Atención</strong></td>
    </tr>
    <tr>
        <td >
        ...
        <td>
            <asp:GridView ID="gdvLista" runat="server" BackColor="White" AutoGenerateColumns="false" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass= "table table-striped table-bordered table-condense">
               <Columns>
                     ...
                     <asp:HyperLinkField HeaderText ="Modificar" DataNavigateUrlFormatString="centroEditarBoxAdm.aspx?id={0}#top" DataNavigateUrlFields="id_box" Text="Modificar" />
